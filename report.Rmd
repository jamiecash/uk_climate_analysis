...
2) The prepared data was then processed to create two summary datasets: i) Seasonal high, low, average max and average min temperature across all weather stations by year; and ii) Annual high, low and highest monthly rainfall by station by year. The processing steps are available in [Appendix II](process.html).
